...
class Ui_Won(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Win")
        Dialog.resize(725, 444)
        self.textLabel = QtWidgets.QLabel(Dialog)
        self.textLabel.setGeometry(QtCore.QRect(160, 40, 361, 41))
        font = QtGui.QFont()
        ...
        self.gifLabel.setGeometry(QtCore.QRect(40, 110, 480, 270))
        self.gifLabel.setObjectName("gifLabel")
        self.formLayoutWidget = QtWidgets.QWidget(Dialog)
        self.formLayoutWidget.setGeometry(QtCore.QRect(559, 110, 141, 80))
        ...
        self.menuButton.setGeometry(QtCore.QRect(560, 220, 141, 41))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.textLabel.setText(_translate("Dialog", "Congratulations! You won!"))
